...
public class WasteManagementEdge {

    static List<FogDevice> fogDevices = new ArrayList<>();
    static List<Sensor> sensors = new ArrayList<>();

    static int numOfBinsPerArea = 28;

    public static void main(String[] args) {

        Log.printLine("Starting Edge Waste Management Simulation...");
        ...
        try {
            ...
            moduleMapping.addModuleToDevice("waste_analyzer", "d-0");
            ...
            Log.printLine("Edge Simulation finished!");
